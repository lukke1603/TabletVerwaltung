...
//                    | Barcode.CODE_39
            ...
            cameraSource = new CameraSource.Builder(ReaderActivity.this, barcodeDetector).setFacing(CameraSource.CAMERA_FACING_BACK).setRequestedPreviewSize(cameraView.getWidth(), cameraView.getHeight()).build();
